...
// checks if the RoleSelectComponentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleSelectComponentResponse{}

// RoleSelectComponentResponse struct for RoleSelectComponentResponse
...
type _RoleSelectComponentResponse RoleSelectComponentResponse
...
func NewRoleSelectComponentResponse(type_ int32, id int32, customId string) *RoleSelectComponentResponse {
	this := RoleSelectComponentResponse{}
	this.Type = type_
	this.Id = id
...
func (o *RoleSelectComponentResponse) SetPlaceholderNil() {
...
func (o *RoleSelectComponentResponse) SetMinValuesNil() {
	o.MinValues.Set(nil)
}
...
func (o *RoleSelectComponentResponse) SetMaxValuesNil() {
	o.MaxValues.Set(nil)
}
...
func (o *RoleSelectComponentResponse) SetDisabledNil() {
	o.Disabled.Set(nil)
}
...
func (o RoleSelectComponentResponse) MarshalJSON() ([]byte, error) {
...
func (o RoleSelectComponentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RoleSelectComponentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleSelectComponentResponse := _RoleSelectComponentResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoleSelectComponentResponse)

	if err != nil {
		return err
	}

	*o = RoleSelectComponentResponse(varRoleSelectComponentResponse)

	return err
}

type NullableRoleSelectComponentResponse struct {
	value *RoleSelectComponentResponse
	isSet bool
}

func (v NullableRoleSelectComponentResponse) Get() *RoleSelectComponentResponse {
	return v.value
}

func (v *NullableRoleSelectComponentResponse) Set(val *RoleSelectComponentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleSelectComponentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleSelectComponentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleSelectComponentResponse(val *RoleSelectComponentResponse) *NullableRoleSelectComponentResponse {
	return &NullableRoleSelectComponentResponse{value: val, isSet: true}
}

func (v NullableRoleSelectComponentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleSelectComponentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
