...
// checks if the StringSelectComponentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StringSelectComponentResponse{}

// StringSelectComponentResponse struct for StringSelectComponentResponse
type StringSelectComponentResponse struct {
	...
	Options []StringSelectOptionResponse `json:"options"`
}

type _StringSelectComponentResponse StringSelectComponentResponse
...
func NewStringSelectComponentResponse(type_ int32, id int32, customId string, options []StringSelectOptionResponse) *StringSelectComponentResponse {
	this := StringSelectComponentResponse{}
	this.Type = type_
	this.Id = id
...
func (o *StringSelectComponentResponse) SetPlaceholderNil() {
...
func (o *StringSelectComponentResponse) SetMinValuesNil() {
	o.MinValues.Set(nil)
}
...
func (o *StringSelectComponentResponse) SetMaxValuesNil() {
	o.MaxValues.Set(nil)
}
...
func (o *StringSelectComponentResponse) SetDisabledNil() {
	o.Disabled.Set(nil)
}
...
func (o *StringSelectComponentResponse) GetOptions() []StringSelectOptionResponse {
	if o == nil {
		var ret []StringSelectOptionResponse
		return ret
	}
...
func (o StringSelectComponentResponse) MarshalJSON() ([]byte, error) {
...
func (o StringSelectComponentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *StringSelectComponentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varStringSelectComponentResponse := _StringSelectComponentResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStringSelectComponentResponse)

	if err != nil {
		return err
	}

	*o = StringSelectComponentResponse(varStringSelectComponentResponse)

	return err
}

type NullableStringSelectComponentResponse struct {
	value *StringSelectComponentResponse
	isSet bool
}

func (v NullableStringSelectComponentResponse) Get() *StringSelectComponentResponse {
	return v.value
}

func (v *NullableStringSelectComponentResponse) Set(val *StringSelectComponentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStringSelectComponentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStringSelectComponentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStringSelectComponentResponse(val *StringSelectComponentResponse) *NullableStringSelectComponentResponse {
	return &NullableStringSelectComponentResponse{value: val, isSet: true}
}

func (v NullableStringSelectComponentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStringSelectComponentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
