...
// checks if the ChannelSelectComponentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChannelSelectComponentResponse{}

// ChannelSelectComponentResponse struct for ChannelSelectComponentResponse
...
type _ChannelSelectComponentResponse ChannelSelectComponentResponse
...
func NewChannelSelectComponentResponse(type_ int32, id int32, customId string) *ChannelSelectComponentResponse {
	this := ChannelSelectComponentResponse{}
	this.Type = type_
	this.Id = id
...
func (o *ChannelSelectComponentResponse) SetPlaceholderNil() {
...
func (o *ChannelSelectComponentResponse) SetMinValuesNil() {
	o.MinValues.Set(nil)
}
...
func (o *ChannelSelectComponentResponse) SetMaxValuesNil() {
	o.MaxValues.Set(nil)
}
...
func (o *ChannelSelectComponentResponse) SetDisabledNil() {
	o.Disabled.Set(nil)
}
...
func (o ChannelSelectComponentResponse) MarshalJSON() ([]byte, error) {
...
func (o ChannelSelectComponentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ChannelSelectComponentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varChannelSelectComponentResponse := _ChannelSelectComponentResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChannelSelectComponentResponse)

	if err != nil {
		return err
	}

	*o = ChannelSelectComponentResponse(varChannelSelectComponentResponse)

	return err
}

type NullableChannelSelectComponentResponse struct {
	value *ChannelSelectComponentResponse
	isSet bool
}

func (v NullableChannelSelectComponentResponse) Get() *ChannelSelectComponentResponse {
	return v.value
}

func (v *NullableChannelSelectComponentResponse) Set(val *ChannelSelectComponentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableChannelSelectComponentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableChannelSelectComponentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChannelSelectComponentResponse(val *ChannelSelectComponentResponse) *NullableChannelSelectComponentResponse {
	return &NullableChannelSelectComponentResponse{value: val, isSet: true}
}

func (v NullableChannelSelectComponentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChannelSelectComponentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
